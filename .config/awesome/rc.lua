...
-- https://www.reddit.com/r/awesomewm/comments/box4jk/my_functional_dynamic_border_gap_and_titlebar/enqjk7t?utm_source=share&utm_medium=web2x
...
--beautiful.init(gears.filesystem.get_configuration_dir() .. "light.lua")
...
mainmenu = awful.menu(mainmenuitems)

menubutton = awful.widget.launcher({ image = beautiful.awesome_icon,
                                     menu  = mainmenu })
...
awful.screen.connect_for_each_screen(function(s)
	...
	awful.tag({ "q", "w", "e", "r", "t" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
	...
	-- Menubar
	awful.key({ modkey }, "p", function() awful.util.spawn_with_shell("dmenu_run -fn \"xos4 Terminus:pixelsize=18\" -nb \"#282828\" -nf \"#928374\" -sb \"#d65d0e\" -sf \"#ebdbb2\"") end,
...
client.connect_signal("request::titlebars", function(c)
	...
	-- Vertical bar
	awful.titlebar(c, {size=20; position="left"}) : setup {
		{ -- Top
